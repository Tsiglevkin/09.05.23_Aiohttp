...
class UserView(web.View):
    ...
    async def post(self):
        ...
        except IntegrityError as error:  # если пользователь существует, генерим ошибку.
    ...
    async def patch(self):
        ...
        user_validated_data = validate(json_data=user_data, model_class=User)  # валидируем данные
